...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4"><a href="{{ route('superadmin.gallery.videos') }}">Add videos</a></div>
            <div class="col-md-4"><a href="{{ route('superadmin.gallery.images') }}">Add images</a></div>
            <div class="col-md-4"><a href="{{ route('superadmin.gallery.files') }}">Add files</a></div>
        </div>

        <div class="row justify-content-round mt-3">
            <a href="{{ route('superadmin.gallery.video_view') }}" class="col-md-4">
            ...
            <a href="{{ route('superadmin.gallery.image_view') }}" class="col-md-4">
                <div id="box" class="card">
                    <div class="card-header">
                        <h5>Images</h5>
                    </div>
            ...
            <a href="{{ route('superadmin.gallery.file_view') }}" class="col-md-4">
                <div id="box" class="card">
                    <div class="card-header">
                        <h5>Files</h5>
                    </div>
