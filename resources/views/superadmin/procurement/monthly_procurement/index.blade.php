...
@section('content')
    <div class="container-fluid p-0">
        <div class="mb-3 row">
            ...
            <div class="col-md-6">
                <a href="{{ route('superadmin.procurement.monthly_procurement.create') }}" class="btn btn-primary">Add</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <form
                                                action="{{ route('superadmin.procurement.monthly_procurement.edit', $procurement) }}"
                                                method="get">
                                                @csrf
                                        ...
                                        <div class="col-md-6">
                                            <form
                                                action="{{ route('superadmin.procurement.monthly_procurement.destroy', $procurement) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
