...
@section('content')
    <div class="container-fluid p-0">
        <div class="mb-3 row">
            <div class="col-md-6">
                <h1 class="h3 d-inline align-middle">Edit Procurement</h1>
            </div>
            <div class="col-md-6">
                {{-- <a href="" class="btn btn-primary">Back</a> --}}
                <a href="{{ route('superadmin.procurement.monthly_procurement') }}" style="float: right"
        ...
        <div class="row">
            ...
            <form action="{{ route('admin.procurement.monthly_procurement.edit', $procurement) }}" method="post">
                @method("PATCH")
                @csrf
                <div class="row">
