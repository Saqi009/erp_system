                ...
                <div class="card">
                    ...
                    <div class="row mb-3">
                        <div class="card-body p-5 col-md-6 mx-auto ">
                            ...
                            <hr>
                            <div class="mb-2">
                                <a href="{{ route('admin.employee.edit', $employee) }}" class="btn btn-primary">Edit</a>

                                <form action="{{ route('admin.employee.destroy', $employee) }}" method='post' class="d-inline">
                                    @method('DELETE')
                                    @csrf
                            ...
                            <a href="{{ route('admin.employee.password', $employee) }}">Change employee password</a>
                        </div>
