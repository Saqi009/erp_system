        ...
        <div class="dashboard">
            ...
            <div class="card-container">
                ...
                <div class="card monthly">
                    ...
                    <a href="{{ route('admin.procurement.monthly_procurement') }}" style="text-decoration: none" class="card-button">Monthly Procurement</a>
                </div>
                ...
                <div class="card full">
                    ...
                    <a href="{{ route('admin.procurement.full_procurement') }}" style="text-decoration: none" class="card-button">Full Procurement</a>
                </div>
                ...
                <div class="card laptop">
                    ...
                    <a href="{{ route('admin.procurement.assign_laptop_procurement') }}" style="text-decoration: none" class="card-button">Full Procurement</a>
                </div>
            </div>
        </div>
