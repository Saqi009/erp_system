                ...
                <div class="card p-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 ">
                                <a href="{{ route('admin.admin_lead') }}" style="float: right;"
                    ...
                    <div class="row">
                        <div class="col-md-10 mx-auto">
                            ...
                            <div>
                                <a href="{{ route('admin.admin_lead.edit', $lead) }}" class="btn btn-primary">Edit</a>

                                <form action="{{ route('admin.admin_lead.destroy', $lead) }}" method='post' class="d-inline">
                                    @method('DELETE')
                                    @csrf
