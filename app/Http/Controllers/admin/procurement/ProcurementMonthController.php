...
class ProcurementMonthController extends Controller
{
    public function index() {
        return view('admin.procurement.monthly_procurement.index', [
            'procurements' => Auth::user()->procurement_months,
        ]);
    }

    public function create() {
        return view('admin.procurement.monthly_procurement.create');
    }
    ...
    public function edit(ProcurementMonth $procurement) {
        return view('admin.procurement.monthly_procurement.edit', [
    ...
    public function destroy(ProcurementMonth $procurement)
    {
        if ($procurement->delete()) {
            return redirect()->route('admin.procurement.monthly_procurement')->with(['success' => "Successfully, Deleted data"]);
        } else {
