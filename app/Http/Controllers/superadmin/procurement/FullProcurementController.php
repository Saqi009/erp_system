...
class FullProcurementController extends Controller
{
    ...
    {
        return view('superadmin.procurement.full_procurement.index', [
            'procurements' => Auth::user()->full_procurements()->paginate(7),
        ]);
    }

    public function create()
    {
        return view('superadmin.procurement.full_procurement.create');
    }
    ...
    {
        return view('superadmin.procurement.full_procurement.edit', [
    ...
    public function destroy(FullProcurement $procurement)
    {
        if ($procurement->delete()) {
            return redirect()->route('superadmin.procurement.full_procurement')->with(['success' => "Successfully, Deleted data"]);
        } else {
